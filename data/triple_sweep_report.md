...
Bias read: the PREVIOUS completed DAILY candle of DXY and EURGBP, carried onto the next day's bars (body must exceed **15%** of the day's range or the day reads flat). Quadrant occupancy — flat (no setup) on **5876** bars; 1a 3701, 1b 3744, 2a 4276, 2b 2777.
...
QUAD-ok IS    268   48.9%    78.4%     43.4     41.3   39.6%
QUAD-ok OOS    279   50.5%    70.6%     33.8     30.8   40.9%
QUAD-no IS   1156   53.6%    77.2%     50.2     41.6   40.1%
QUAD-no OOS   1359   50.6%    67.0%     32.4     32.4   36.9%
```

**Verdict (raid vs single-pair control): YELLOW** — positive but weak (+2.1pp IS / +1.5pp OOS)
**Verdict (quadrant-aligned vs not): RED** — no consistent lift (-4.8pp IS / -0.0pp OOS)
...
QUAD-ok IS    223   46.6%    74.0%     45.4     51.7   39.0%
QUAD-ok OOS    257   53.3%    74.7%     37.3     28.5   40.1%
QUAD-no IS   1201   49.8%    75.9%     43.7     43.7   37.8%
QUAD-no OOS   1313   51.3%    70.4%     35.1     32.0   38.8%
```

**Verdict (raid vs single-pair control): RED** — no consistent lift (+1.8pp IS / -0.7pp OOS)
**Verdict (quadrant-aligned vs not): RED** — no consistent lift (-3.2pp IS / +2.1pp OOS)
