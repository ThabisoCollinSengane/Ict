...
| Breakeven | 7 |
| Session-end close (negative) | 5 |
| Losses (stop hit) | **21** |
| Profitable trades | **22** (40%) |
| Total pips | **+128.9** |
| Avg pips/trade | 2.3 |
...
### Tuesday 01 Sep 2026 — 2 setups (0P/0L, +0.0 pips)

| # | Time (ET) | Model | Pair | Dir | Signal | Confirms | Cascade | Result | Pips |
|---|---|---|---|---|---|---|---|---|---|
| 1 | 03:00 | MM | GBPUSD | SELL | STRONG | IFVG+MSS+SMT | Y | **CLOSE** | +0.0 |
| 2 | 03:00 | MM | GBPUSD | SELL | STRONG | IFVG+MSS+SMT | Y | **CLOSE** | +0.0 |

## Session Breakdown

| Session | Trades | Prof | L | WR | Pips |
|---|---|---|---|---|---|
| London Open | 19 | 7 | 8 | 37% | -4.2 |
...
|---|---|---|---|---|---|
| STRONG (>=3 confirms) | 30 | 11 | 10 | 37% | +77.8 |
...
54. **CLOSE** [MM] SELL GBPUSD — Tue 01 03:00 ET (London Open) — STRONG [IFVG+MSS+SMT] — Entry 1.35422, Stop 1.35522, Target 1.35122 — **+0.0 pips**
55. **CLOSE** [MM] SELL GBPUSD — Tue 01 03:00 ET (London Open) — STRONG [IFVG+MSS+SMT] — Entry 1.35422, Stop 1.35522, Target 1.35122 — **+0.0 pips**
...
|---|---|---|---|---|---|---|
| Confirmed (bonds+DXY agree) | 45 | 15 | 18 | 33% | +67.0 | +1.5 |
...
|---|---|---|---|---|---|---|
| Yields agree (2-3/3) | 16 | 3 | 8 | 19% | -11.2 | -0.7 |
| Yields partial (1/3) | 13 | 3 | 8 | 23% | +0.6 | +0.0 |
| Yields flat (0/3) | 60 | 23 | 25 | 38% | +74.7 | +1.2 |

### Layer 1 — DXY vs Daily Open

| State | Trades | Prof | L | WR | Pips | Avg |
|---|---|---|---|---|---|---|
| DXY bid (+1) | 40 | 10 | 18 | 25% | -51.5 | -1.3 |
| DXY flat (0) | 10 | 7 | 3 | 70% | +61.9 | +6.2 |
| DXY offer (-1) | 39 | 12 | 20 | 31% | +53.7 | +1.4 |

### Layer 1b — Bonds/DXY Agreement

| State | Trades | Prof | L | WR | Pips | Avg |
|---|---|---|---|---|---|---|
| Bonds+DXY agree | 10 | 1 | 3 | 10% | -22.8 | -2.3 |
| Bonds+DXY disagree | 69 | 21 | 35 | 30% | +25.0 | +0.4 |
| N/A (DXY flat) | 10 | 7 | 3 | 70% | +61.9 | +6.2 |

### Layer 1c — Bonds/DXY SMT Divergence

| State | Trades | Prof | L | WR | Pips | Avg |
|---|---|---|---|---|---|---|
| SMT divergence | 58 | 16 | 31 | 28% | +11.3 | +0.2 |
| No SMT | 31 | 13 | 10 | 42% | +52.8 | +1.7 |

### Layer 2 — EURGBP Bias (pair selection)

| State | Trades | Prof | L | WR | Pips | Avg |
|---|---|---|---|---|---|---|
| EUR > GBP (+1) | 5 | 2 | 1 | 40% | +12.3 | +2.5 |
| Flat (0) | 83 | 27 | 40 | 33% | +51.8 | +0.6 |
...
| State | Trades | Prof | L | WR | Pips | Avg |
|---|---|---|---|---|---|---|
| No entry SMT | 89 | 29 | 41 | 33% | +64.1 | +0.7 |

### Curve Stress

| State | Trades | Prof | L | WR | Pips | Avg |
|---|---|---|---|---|---|---|
| Normal | 2 | 1 | 1 | 50% | +0.0 | +0.0 |

## Cascade Gate Impact

| Scenario | Trades | WR | Losses | Pips | Avg |
|---|---|---|---|---|---|
| WITHOUT gate (all) | 89 | 33% | 41 | +64.1 | +0.7 |
| **WITH gate (shipped)** | **55** | **40%** | **21** | **+128.9** | **+2.3** |
| Gated out (all reasons) | 34 | 21% | 20 | -64.8 | -1.9 |
|   — against | 34 | 21% | 20 | -64.8 | -1.9 |

**Gate effect:** WR 33% -> 40% (+7pp), avg pips/trade +0.7 -> +2.3
...
| 16 | Mon 27 Jul | 05:00 | AMD | GBPUSD | SELL | against | WIN | +30.0 |
| 17 | Tue 28 Jul | 05:00 | AMD | GBPUSD | SELL | against | TRAIL | +10.0 |
...
| 24 | Thu 13 Aug | 04:00 | AMD | EURUSD | BUY | against | TRAIL | +10.0 |
| 25 | Thu 13 Aug | 05:00 | AMD | EURUSD | BUY | against | TRAIL | +10.0 |
