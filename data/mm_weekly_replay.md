...
| London→NY Overlap | 12 | 3 | 8 | 25% | +19.1 |
| NY AM | 9 | 4 | 2 | 44% | +90.5 |
...
|---|---|---|---|---|---|
| STRONG (>=3 confirms) | 26 | 10 | 9 | 38% | +77.8 |
...
| Flat (no dollar signal) | 8 | 6 | 2 | 75% | +61.9 | +7.7 |
...
|---|---|---|---|---|---|---|
| Yields agree (2-3/3) | 15 | 3 | 9 | 20% | -16.7 | -1.1 |
| Yields partial (1/3) | 13 | 3 | 8 | 23% | +0.6 | +0.0 |
| Yields flat (0/3) | 58 | 22 | 24 | 38% | +74.7 | +1.3 |

### Layer 1 — DXY vs Daily Open

| State | Trades | Prof | L | WR | Pips | Avg |
|---|---|---|---|---|---|---|
| DXY bid (+1) | 39 | 10 | 19 | 26% | -57.0 | -1.5 |
...
| State | Trades | Prof | L | WR | Pips | Avg |
|---|---|---|---|---|---|---|
| No entry SMT | 86 | 28 | 41 | 33% | +58.6 | +0.7 |
...
|---|---|---|---|---|---|
| WITHOUT gate (all) | 86 | 33% | 41 | +58.6 | +0.7 |
| **WITH gate (shipped)** | **51** | **41%** | **20** | **+128.9** | **+2.5** |
| Gated out (all reasons) | 35 | 20% | 21 | -70.3 | -2.0 |
|   — against | 35 | 20% | 21 | -70.3 | -2.0 |

**Gate effect:** WR 33% -> 41% (+9pp), avg pips/trade +0.7 -> +2.5
