...
| # | Time (ET) | Model | Pair | Dir | Signal | Confirms | Cascade | Result | Pips |
|---|---|---|---|---|---|---|---|---|---|
| 1 | 03:50 | MM | GBPUSD | SELL | STRONG | IFVG+MSS+SMT | Y | **CLOSE** | +0.0 |
| 2 | 03:50 | MM | GBPUSD | SELL | STRONG | IFVG+MSS+SMT | Y | **CLOSE** | +0.0 |

## Session Breakdown

| Session | Trades | Prof | L | WR | Pips |
|---|---|---|---|---|---|
| London Open | 19 | 7 | 8 | 37% | +35.8 |
...
|---|---|---|---|---|---|
| STRONG (>=3 confirms) | 30 | 11 | 10 | 37% | +77.6 |
...
54. **CLOSE** [MM] SELL GBPUSD — Tue 01 03:50 ET (London Open) — STRONG [IFVG+MSS+SMT] — Entry 1.35366, Stop 1.35466, Target 1.35166 — **+0.0 pips**
55. **CLOSE** [MM] SELL GBPUSD — Tue 01 03:50 ET (London Open) — STRONG [IFVG+MSS+SMT] — Entry 1.35366, Stop 1.35466, Target 1.35166 — **+0.0 pips**
...
|---|---|---|---|---|---|---|
| Confirmed (bonds+DXY agree) | 45 | 15 | 18 | 33% | +27.9 | +0.6 |
...
|---|---|---|---|---|---|---|
| Yields agree (2-3/3) | 16 | 3 | 8 | 19% | -20.1 | -1.3 |
| Yields partial (1/3) | 13 | 3 | 8 | 23% | -19.6 | -1.5 |
| Yields flat (0/3) | 60 | 23 | 25 | 38% | +129.2 | +2.2 |

### Layer 1 — DXY vs Daily Open

| State | Trades | Prof | L | WR | Pips | Avg |
|---|---|---|---|---|---|---|
| DXY bid (+1) | 40 | 10 | 18 | 25% | -41.5 | -1.0 |
| DXY flat (0) | 10 | 7 | 3 | 70% | +101.9 | +10.2 |
...
| N/A (DXY flat) | 10 | 7 | 3 | 70% | +101.9 | +10.2 |
...
| Flat (0) | 81 | 27 | 40 | 33% | +67.2 | +0.8 |
| GBP > EUR (-1) | 3 | 0 | 0 | 0% | +0.0 | +0.0 |

### Layer 3 — EU/GU Entry SMT

| State | Trades | Prof | L | WR | Pips | Avg |
|---|---|---|---|---|---|---|
| No entry SMT | 89 | 29 | 41 | 33% | +89.5 | +1.0 |

### Curve Stress

| State | Trades | Prof | L | WR | Pips | Avg |
|---|---|---|---|---|---|---|
| Normal | 2 | 1 | 1 | 50% | +10.0 | +5.0 |

## Cascade Gate Impact

| Scenario | Trades | WR | Losses | Pips | Avg |
|---|---|---|---|---|---|
| WITHOUT gate (all) | 89 | 33% | 41 | +89.5 | +1.0 |
| **WITH gate (shipped)** | **55** | **40%** | **21** | **+129.8** | **+2.4** |
| Gated out (all reasons) | 34 | 21% | 20 | -40.3 | -1.2 |
|   — against | 34 | 21% | 20 | -40.3 | -1.2 |

**Gate effect:** WR 33% -> 40% (+7pp), avg pips/trade +1.0 -> +2.4
