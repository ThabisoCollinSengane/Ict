...
class Backtester:
    ...
    def _exit_leg(self, pair, leg, exit_price, t, reason):
        ...
        record = {
            ...
            "narrative_rate": st.get("narrative_rate", 0),
            "narrative_pd_prov": st.get("narrative_pd_prov", 0),
            "narrative_seasonal": st.get("narrative_seasonal", 0),
            "narrative_htf_ob": st.get("narrative_htf_ob", 0),
            "narrative_d1_draw": st.get("narrative_d1_draw", 0),
            "htf_ob_context": st.get("htf_ob_context", ""),
            "htf_ob_liq_type": st.get("htf_ob_liq_type", ""),
            "d1_draw_type": st.get("d1_draw_type", ""),
            "d1_draw_price": st.get("d1_draw_price", ""),
